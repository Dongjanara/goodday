...
<div class="Tre tway1"></div>
    <div class="list-group "style="max-width: 350px;" >
        ...
        <a href="getMyInfo.do" class="list-group-item list-group-item-success active" aria-current="true"style="height:60px">내 정보</a>
...
<div class="col-9 display " > 
<div class="" style=" width: 70% ;">
<div class="Tre tway1 ">My Info</div>
		<br>
	
		 <form action="userUpdate.do?tid=${sid}" class="" method = "post">
			<table>
				<tr>
					<td  colspan="2" style="font-weight:bold;">기본 정보</td>	
				</tr>
				...
				<tr>
					...
					<td><span class="Rtext3" >${sid}</span><br></td>
				</tr>

				<tr>
					<td style="font-weight:bold;"> PW *</td>
					<td><input class="Rtext input_pw" type="password" value= "${stv.pw }" name = "pw" required oninput="changeClass()">
				...
				<tr>
					<td style="font-weight:bold;">PW*</td>
					<td>
					<input class="Rtext input_pw2" type="password" name="pw2" placeholder="password" value="${stv.pw}" required oninput="changeClass()">
					<br>
					</td>
               ...
               <td><input type="text" name = "ttel"class="Rtext input_phone"  value= "${stv.ttel }"     minlength = "11" maxlength = "11" oninput="checkInputs()" required>
            ...
            <tr>
               ...
               <td><input type="text" name = "email" class="Rtext input_email" value= "${stv.email }"
               ...
               <span id="checkEmail" style="font-size: 12px;"></span><br>
				...
				<tr>
					...
					<td>
					<input class="Rtext2" type="text" id="sample6_postcode"	value= "${stv.adp }" name = "adp" required>
				...
				<tr>
					...
					<td>
					<input class="Rtext" id="sample6_address" type="text"value= "${stv.ad }" name = "ad" required oninput="changeClass()">
					<br>
					</td>
				</tr>
				...
				<tr>
					<td class="td1"></td>
					<td>
					<input class="Rtext" id="sample6_detailAddress" type="text" value= "${stv.ad1 }" name = "ad1" oninput="changeClass()">
					<br>
					</td>
				</tr>
				...
				<tr>
					<td class="td1">
					<input type = "hidden" value= "${sid }" name = "tid">
					</td>
					<td>
					<input class="Rtext" type="hidden" id="sample6_extraAddress" placeholder="참고항목">
					<br>
					</td>
				</tr>
			</table>
				...
				<div style="text-align:center;">
				 <input id="infoSubmit" class="infobox3" type="submit" value=" 정보 수정" disabled>
				<input class="infobox2" type="button" value="돌아가기" onclick="goToMainPage()">
				</div>
		</form> 
</div>
</div>	
			...
			<div class="footer-menu">
				...
				<div class="first-box">
					...
					<div class="column">
						...
						<div ><a  class="menu-item-1" href = userDelete.do?tid=${sid}>회원 탈퇴 </a></div>
					</div>
				</div>
...
$('.input_email').on('input', function () {
   ...
   function changeClass() {
       document.getElementById('infoSubmit').classList.replace('infobox3', 'infobox2');
       document.getElementById('infoSubmit').disabled = false;
   }
   
    function goToMainPage() {
        // 00_main.jsp 페이지로 리다이렉션
        window.location.href = '00_main.jsp';
    }
</script>
</body>
</html>